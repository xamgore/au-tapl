...
rec = Rcd  [("lK",cK),("lB1",Tru),("lB2",Fls)]
pat = PRcd [("lB2",PVar "x"),("lK",PVar "y")]

e1 = infer0 rec
t1 = e1 == Just (TRcd [("lK",Boo :-> (Boo :-> Boo)),("lB1",Boo),("lB2",Boo)])

e2 = checkPat pat <$> infer0 rec
t2 = e2 == Just (Just (Env [("x",Boo),("y",Boo :-> (Boo :-> Boo))]))

e3 = infer0 $ Let pat rec (Idx 0)
t3 = e3 == Just Boo

e4 = infer0 $ Let pat rec (Idx 1)
t4 = e4 == Just (Boo :-> (Boo :-> Boo))
